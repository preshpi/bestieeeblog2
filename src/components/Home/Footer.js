...
function Footer() {
  return (
    <div class="max-w-screen-xl mx-auto px-4 p-5 ">
    ...
    <div class="pt-8 flex max-w-xs mx-auto items-center justify-between">
        ...
        <a href="https://www.github.com/preshpi" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
        ...
        <div class="text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
            Created by Preshpie and Opemipo
